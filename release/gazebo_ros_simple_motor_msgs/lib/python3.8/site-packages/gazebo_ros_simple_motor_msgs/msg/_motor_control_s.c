...
bool gazebo_ros_simple_motor_msgs__msg__motor_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_ros_simple_motor_msgs.msg._motor_control.MotorControl", full_classname_dest, 60) == 0);
  }
  gazebo_ros_simple_motor_msgs__msg__MotorControl * ros_message = _ros_message;
  {  // mode
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * gazebo_ros_simple_motor_msgs__msg__motor_control__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MotorControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_ros_simple_motor_msgs.msg._motor_control");
  ...
  gazebo_ros_simple_motor_msgs__msg__MotorControl * ros_message = (gazebo_ros_simple_motor_msgs__msg__MotorControl *)raw_ros_message;
  {  // mode
    PyObject * field = NULL;
